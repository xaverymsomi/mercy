...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2022 at 09:10 PM
...
(3, 1, 'mzumbe', 12000, 'dggbf', '2022-10-17'),
(4, 1, 'mzumbe', 100, 'p;k\r\np,\r\n6', '2022-10-17'),
(5, 1, 'mzumbe', 1000, 'wdqashd ', '2022-10-17'),
(6, 1, 'mzumbe', 1000, 'wdqashd ', '2022-10-17'),
(7, 1, 'mzumbe', 10000, 'd', '2022-10-17');
...
(6, 'EXIM BANK', '2022-10-17 20:43:31', 14),
(7, 'CRDB BANK', '2022-10-17 20:44:27', 14),
(8, 'NMB BANK', '2022-10-17 20:59:44', 14);
...
(3, 6, 0, 0, 0, '2022-10-17 21:52:08', 14),
(4, 7, 0, 0, 0, '2022-10-17 21:52:14', 14),
(5, 8, 0, 0, 0, '2022-10-17 21:52:20', 14);
...
(3, 1000000, NULL, '0', '2022-10-17 21:48:30', 14),
(4, 20000, 3, '0', '2022-10-17 21:52:42', 14),
(5, 30000, 4, '0', '2022-10-17 21:53:31', 14);
...
(5, 4, 1000000, 7, '2022-10-17 22:23:04', 14);
...
(4, 'company', '2022-10-17 20:57:22', 14),
(5, 'organization', '2022-10-17 20:57:29', 14);
...
(10, 'Commit expenditure of amount Tsh.10000/=', '2022-10-17 17:07:03', 14),
(11, 'adding new expenditure type', '2022-10-17 17:08:41', 14),
(12, 'adding new income source type', '2022-10-17 19:57:09', 14),
(13, 'adding new account Chart type', '2022-10-17 19:58:33', 14),
(14, 'adding new account Chart type', '2022-10-17 19:58:52', 14),
(15, 'adding new account', '2022-10-17 19:59:28', 14),
(16, 'adding new income', '2022-10-17 20:02:14', 14),
(17, 'adding new account Chart type', '2022-10-17 20:03:42', 14),
(18, 'adding new account Chart type', '2022-10-17 20:20:15', 14),
(19, 'adding new income source type', '2022-10-17 20:21:35', 14),
(20, 'adding new account Chart type', '2022-10-17 20:43:31', 14),
(21, 'adding new account Chart type', '2022-10-17 20:44:27', 14),
(22, 'adding new income source type', '2022-10-17 20:57:22', 14),
(23, 'adding new income source type', '2022-10-17 20:57:29', 14),
(24, 'adding new expenditure type', '2022-10-17 20:58:26', 14),
(25, 'adding new account', '2022-10-17 21:52:08', 14),
(26, 'adding new account', '2022-10-17 21:52:14', 14),
(27, 'adding new account', '2022-10-17 21:52:20', 14),
(28, 'adding new income', '2022-10-17 22:19:49', 14),
(29, 'adding new income', '2022-10-17 22:21:22', 14),
(30, 'adding new account', '2022-10-17 22:22:04', 14),
(31, 'adding new income', '2022-10-17 22:23:33', 14),
(32, 'adding new income', '2022-10-17 22:52:48', 14),
(33, 'adding new income', '2022-10-17 22:52:51', 14);
...
CREATE TABLE `user` (
  ...
  `is_driver/manager` enum('0','1','2','') NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user` (`user_id`, `first_name`, `last_name`, `sex`, `email`, `username`, `is_admin`, `is_active`, `password`, `registred_at`, `profile_picture`, `is_driver/manager`) VALUES
(14, 'Mercy', 'Komba', NULL, 'rakib@gmail.com', 'mercy', 1, 1, '$2y$10$uhoIVVUS0P6WEqpUtNIJOej3.JLCZ61NAyHzDIFHLY9CBshUfPyAi', '2022-01-21 10:46:05', 0, '0'),
(33, 'vicent', 'msomi', NULL, 'msomivicent@gmail.com', 'vicent', 0, 1, '81dc9bdb52d04dc20036dbd8313ed055', '2022-10-19 17:29:32', 0, '1'),
(34, 'peter', 'msomi', NULL, 'peter@gmail.com', 'peter', 0, 1, '81dc9bdb52d04dc20036dbd8313ed055', '2022-10-19 19:01:48', 0, '2');
...
--
ALTER TABLE `mantainance`
  MODIFY `mant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_account_chart`
  MODIFY `acount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbl_expenditure_logs`
  MODIFY `expenditure_logs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_income_list`
  MODIFY `income_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
